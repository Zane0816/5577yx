    ...
    public class HtmlHelper : IRequiresSessionState
    {
        ...
        public string OrderHtml(DataTable dt)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                HtmlStr += "<tr><td><a>" + row["OrderNo"] + "</a></td><td>" + Type + "</td><td>" + row["PayTypeName"] + "</td><td>" + State + "</td><td>" + row["UserName"] + "</td><td>" + row["PayMoney"] + "</td><td>" + row["Source"] + "</td><td>" + row["PayTime"] + "</td><td>" + row["Bz"] + "</td><td>" + row["GameName"] + "-" + row["ServerName"] + "</td><td>" + row["AdminUserName"] + "</td></tr>";
            }
            return HtmlStr;
        }
        ...
        public string CollectHtml(DataTable dt, int MaxMoney, int MinMoney)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                if (int.Parse(PayMoney) >= MaxMoney)
                {
                    PayMoney = "<span style=\"color: red\">" + PayMoney + "</span>";
                }
                else if (int.Parse(PayMoney) <= MinMoney)
                {
